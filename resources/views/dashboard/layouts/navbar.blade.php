    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index-2.html"><img src="{{ asset('assets3/images/logo.svg') }}" width="30" alt="sQuare"><span class="m-l-10">المجلة الالكترونية</span></a>
            </div>
        </li>
        <li>
                    ...
                    <ul class="menu list-unstyled">
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{ asset('assets3/images/xs/avatar5.jpg') }}" alt="">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{ asset('assets3/images/xs/avatar6.jpg') }}" alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{ asset('assets3/images/xs/avatar3.jpg') }}" alt="">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{ asset('assets3/images/xs/avatar4.jpg') }}" alt="">
                                    <div class="media-body">
